...
ClipBrain should sound like a founder building the tool he needed for himself.

## Feel

- Builder-first, not marketer-first
- Technical, but not tangled
...
- Short posts with one clear idea
- Real build details from commits, docs, demos, or bugs
- Plain sentences
